...
export default function AdminDashboardLayout({
  ...
  return (
    <div className="min-h-screen bg-background flex overflow-hidden w-full max-w-full">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed lg:static inset-y-0 left-0 z-50 w-72 bg-surface border-r border-border flex flex-col overflow-hidden transform transition-transform duration-300 will-change-transform ${
